...
${plannedRows.length} Cotton order(s) will be assigned. If a DN has no pick task, WISE will create one first, then assign it.`)) return;
  ...
  return <div className="bay-dashboard"><div className="storm-bg" />
    ...
    <section className="stat-grid"><Stat value={0} label="In-Yard Full" /><Stat value={cottonAssignees.length} label="Cotton Assignees" /><Stat value={orders.length} label="Planned Orders" /><Stat value={older48} label="Older Than 48h" /></section>
